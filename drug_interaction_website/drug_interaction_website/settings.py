"""
Django settings for drug_interaction_website project.
...
SECRET_KEY = 'django-insecure-&af9p390*5bj+!gqf-%%et)ai9c2-v4&9+qzk27oy91xmrh!-l'
...
ROOT_URLCONF = 'drug_interaction_website.urls'
...
WSGI_APPLICATION = 'drug_interaction_website.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'drug_interaction/static'),
]
